...
![Labs](https://img.shields.io/badge/Labs_Complete-4-EE3124?style=flat-square)
...
![Commits](https://img.shields.io/badge/Commits-35_and_counting-brightgreen?style=flat-square)
...
- **Detection triad** — Sigma (SIEM-agnostic) + Splunk SPL + Microsoft Sentinel KQL, every time
...
> Most enterprise SOC tools are x86_64 only. Every ARM64 workaround in this lab is fully documented and reproducible. See the lab index below.

---

## Lab Index

All work — investigations, detection rules, setup guides, and threat intelligence — is listed here in one place.
...
| 004 | 🔵 Lab | [DNS Enumeration — Interrogating the Internet](./lab-setup/dns-enumeration/) | dig, nslookup · DNS record analysis · Threat intelligence methodology | ✅ |
...
| **Network Analysis** | Wireshark · tcpdump · Suricata IDS · DNS enumeration · Traffic baselining |
...
Q1 2026
 ...
 ├── 🔄  30 incident investigations  (3 of 30 complete)
...
![Labs](https://img.shields.io/badge/Labs_Complete-4-EE3124?style=for-the-badge)
![Rules](https://img.shields.io/badge/Detection_Rules-3_Live-blue?style=for-the-badge)
![Commits](https://img.shields.io/badge/Commits-35_and_counting-brightgreen?style=for-the-badge)
